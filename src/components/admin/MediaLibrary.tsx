...
export default function MediaLibrary() {
 ...
 <h2 className="text-xl font-bold text-slate-800 ">Product Images Bucket</h2>
 ...
 return (
 <div key={file.id} className="group bg-slate-50 rounded-xl border border-slate-200 overflow-hidden">
