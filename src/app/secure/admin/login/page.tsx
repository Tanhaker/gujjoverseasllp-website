      ...
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-white mb-4 border border-brand-500/20 shadow-lg shadow-brand-500/10 overflow-hidden">
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  name="email"
                  required
                  className="w-full px-4 py-3 rounded-xl border border-slate-700 bg-slate-950 text-white focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all placeholder-slate-600"
            ...
            <form onSubmit={handleMfaSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  pattern="[0-9]{6}"
                  maxLength={6}
                  className="w-full px-4 py-3 rounded-xl border border-slate-700 bg-slate-950 text-white focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all placeholder-slate-600 tracking-[0.5em] text-center text-lg font-mono"
                  placeholder="123456"
                />
              </div>
              <button
