...
export default async function AuditLogsPage({
 ...
 <p className="text-slate-500 mt-2">Append-only security log of all administrative actions.</p>
 </div>
 <div className="bg-amber-100 text-amber-800 px-4 py-2 rounded-lg text-sm flex items-center gap-2 border border-amber-200 ">
 ...
 <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600 font-mono text-xs">
