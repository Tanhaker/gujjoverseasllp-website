...
export default async function DashboardPage() {
 ...
 <p className="text-slate-500 mt-2">Welcome back to your admin portal. Here's what's happening.</p>
 </div>
 ...
 <div key={slug} className="flex justify-between items-center p-3 rounded-lg bg-slate-50 ">
 <span className="font-medium text-slate-700 capitalize">{slug.replace(/-/g, ' ')}</span>
