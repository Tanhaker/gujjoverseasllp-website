...
export default async function ProductsManagementPage() {
 ...
 <div>
 <h1 className="text-3xl font-bold text-slate-900 font-serif">Products Management</h1>
 ...
 <div className="h-10 w-10 flex-shrink-0 bg-slate-100 rounded-lg overflow-hidden relative">
